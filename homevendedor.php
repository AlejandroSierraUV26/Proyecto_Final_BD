...
<head>
    ...
    rel="stylesheet"/>    
    <link rel="stylesheet" href="assets\css\estilosHomeVendedor.css">
    ...
    <div class="contenedor__menu__tablas1">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            if (isset($_POST['consulta'])) {
                ...
                if (stripos($user_query, 'SELECT') !== false) {
                    ...
                    echo '<script>alert("No tiene permisos para realizar operaciones de modificación.");</script>';
                }
            }
        } else {
        ...
        ?>
            ...
            <div class="contenedor__clientes">
                ...
                <form action="procesarVendedor.php" method="post" class="formulario__clientes">
            ...
            <div id="pedidoContenedor" class="contenedor__pedidos">
                ...
                <div class="contenedor__pedidos__registro">
                    ...
                    <form method="post" action="procesar_pedidoVendedor.php">
            ...
            <div class="contenedor__colegios">
                ...
                <div class="contenedor__colegios__formulario">
                    <form action="procesar_colegioVendedor.php" method="post" class="formulario__colegios">
            ...
            <div class="contenedor__uniformes">
                ...
                <form action="procesar_uniformeVendedor.php" method="post" class="formulario__colegios">
            ...
            <div class="contenedor__producto__terminado">
                ...
                <div class="contenedor__producto__terminado__formulario">
                    <form action="procesar_invetarioVendedor.php" method="post" class="formulario__producto__terminado">
        ...
        <div class="derecha">
            <div class="top">
                <h2>VENDEDOR</h2>
                <img src="assets\images\vendedor_imagen.png" alt="">
            </div>
            <?php
            $id = $_GET['id'];
            ...
            <div class="tiempo__activo">
                ...
                <p id="counter2">00:00:00</p>
            </div>
        </div>
    </div>
    <script src="assets\js\scriptHomeVendedor.js"></script>
     <script src="https://code.jquery.com/jquery-3.4.1.js"
        integrity="sha256-WpOohJOqMqqyKL9FccASB9O0KwACQJpFTUBLTYOVvVU=" crossorigin="anonymous">
        </script>
    <script src="https://cdn.datatables.net/1.10.20/js/jquery.dataTables.min.js">
    </script> 
    <script src="assets\js\dataTableConfigVendedor.js"></script>
</body>
</html>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM administradores WHERE usuario = '$usuario' AND contraseña = '$contraseña' AND rol = 'admin'";
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: home.php?id='$usuario'"); // Redirigir al home del administrador
        exit();
    }
     else {
        // Aquí establecemos un mensaje de error directamente en la sesión
        $_SESSION['login_error'] = "Nombre de usuario o contraseña incorrectos o quizas no eres admin :(.";
